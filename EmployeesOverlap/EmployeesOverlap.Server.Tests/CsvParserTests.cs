...
namespace EmployeesOverlap.Server.Tests
{
    public class CsvParserTests
    {
        ...
        public async Task ParseAsync_ValidCsv_ReturnsCorrectWorkRecords()
        {
            ...
            Assert.Equal(new DateTime(2023, 1, 1), result[0].DateFrom);
        }
        ...
        [Theory]
        [InlineData("01.03.2023", "02.03.2023")]
        [InlineData("3/1/2023", "3/2/2023")]
        [InlineData("2023-03-01", "2023-03-02")]
        public async Task ParseAsync_SupportsMultipleDateFormats(string dateFrom, string dateTo)
        {
            ...
            Assert.Single(result);
            Assert.Equal(new DateTime(2023, 3, 1), result[0].DateFrom);
            Assert.Equal(new DateTime(2023, 3, 2), result[0].DateTo);
        }
        [Fact]
