...
- Create Angular project with ng: `ng new employeesoverlap.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`employeesoverlap.client.esproj`).
